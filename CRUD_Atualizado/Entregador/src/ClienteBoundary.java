...
public class ClienteBoundary extends Application {
	...
	private void prepararTable() {
		...
		TableColumn<Cliente, String> col3 = new TableColumn<>("CNH");
		col3.setCellValueFactory(
				new PropertyValueFactory<Cliente, String>("CNH") ); 
	...
	public void vincular() { 
		...
		StringConverter<? extends Number> converterNumber_CNH = 
				new IntegerStringConverter();
		Bindings.bindBidirectional(txtApelido.textProperty(),
				control.CNHProperty(),
				(StringConverter)converterNumber_CNH);
